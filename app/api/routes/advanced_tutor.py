...
async def conduct_socratic_dialogue(
    ...
    if payload.current_step == 1:
        ...
        reply = (
            f"احسنت! تو خودت موفق شدی منطق مسئله رو کشف کنی. "
            f"پاسخ تشریحی کامل: گزینه ۲ صحیحه. چون با نصف شدن فاصله، طبق قانون کولن نیرو ۴ برابر می‌شه. راهبرد تستی: همیشه اول توان مخرج رو ساده کن."
        )
