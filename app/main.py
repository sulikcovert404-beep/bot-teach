...
app.mount("/admin-dashboard", StaticFiles(directory="web/admin", html=True), name="admin-dashboard")
app.mount("/teacher-dashboard", StaticFiles(directory="web/teacher", html=True), name="teacher-dashboard")
app.mount("/student-dashboard", StaticFiles(directory="web/student", html=True), name="student-dashboard")
...
from app.api.routes.controlled_external_beta import external_beta_admin_router, external_beta_router

app.include_router(external_beta_router, prefix="/api/v1")
app.include_router(external_beta_admin_router, prefix="/api/v1")
from app.api.routes.public_launch_readiness import public_launch_admin_router, public_launch_router
...
from app.api.routes.growth_scale_operations import growth_scale_admin_router, growth_scale_router
...
from app.api.routes.operational_excellence import ops_excellence_admin_router, ops_excellence_router
...
from app.api.routes.beta_1000_expansion import beta_expansion_admin_router, beta_expansion_router

app.include_router(beta_expansion_router, prefix="/api/v1")
app.include_router(beta_expansion_admin_router, prefix="/api/v1")
from app.api.routes.commercial_readiness import commercial_prep_admin_router, commercial_prep_router
