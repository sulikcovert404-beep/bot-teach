...
def base(): return {"snapshot_id": "s1","archive_closure_decision_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"snapshot_position": (),"snapshot_summary": {"execution":False},"trace_reference": ref("t")}
