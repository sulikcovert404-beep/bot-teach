...
def base(): return {"manifest_id": "s1","signoff_record_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"archive_scope": ("governance",),"boundary_assertions": {"execution":False},"trace_reference": ref("t")}
