...
def base(): return {"audit_id": "s1","archive_integrity_verification_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"consistency_findings": ("governance",),"boundary_assertions": {"execution":False},"trace_reference": ref("t")}
