...
def base(): return {"package_id": "s1","archive_certification_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"archive_scope": (),"historical_position": {"execution":False},"trace_reference": ref("t")}
