...
def make(**o):
 d={"package_id": "p","governance_closure_summary": "closed","operational_readiness_summary": "closed","transition_certification_summary": "certified","master_review_result": "ready","remaining_restrictions": ("runtime prohibited",),"next_phase_entry_conditions": ("commander approval",),"trace_reference": "t","package_digest": "d"}; d.update(o); return MasterPhaseClosureHandoffPackage(**d)
