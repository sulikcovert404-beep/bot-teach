...
def make(**kw):
 d={'preparation_review_reference': ref(),'runtime_entry_decision_reference': ref(text='e'),'readiness_snapshot_reference': ref(text='s'),'environment_readiness_reference': ref(text='v'),'trace_reference': ref(text='t')}; d.update(kw); return RuntimeEntryReadinessReconciliation('r1',**d)
