...
def make(**k):
 d={'state_model_id': 's','decision_framework_reference': 'd','decision_review_reference': 'r','assessment_reference': 'a','state_definitions': {'READY':'readiness only'},'state_transition_rules': ('reviewed',),'state_constraints': ('non-runtime',),'scope_exclusions': ('runtime',),'boundary_assertions': {'runtime_state':False,'activation_state':False,'permission_state':False},'trace_reference': 't','state_digest': 'h'}; d.update(k); return OperationalReadinessStateModel(**d)
