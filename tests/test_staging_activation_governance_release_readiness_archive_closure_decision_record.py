...
def base(): return {"decision_id": "s1","archive_closure_review_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"closure_outcome": (),"decision_scope": {"execution":False},"trace_reference": ref("t")}
