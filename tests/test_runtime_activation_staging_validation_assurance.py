...
def make(**k):
 d={'assurance_id': 'a1','staging_validation_framework_reference': 'f:1','staging_evidence_governance_reference': 'g:1','final_readiness_review_reference': 'r:1','activation_decision_reference': 'd:1','readiness_baseline_freeze_reference': 'b:1','assurance_findings': (),'trace_reference': 't:1'}; d.update(k); return A(**d)
