...
def base(): return {"review_id": "s1","archive_final_package_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"closure_findings": (),"dependency_summary": {"execution":False},"trace_reference": ref("t")}
