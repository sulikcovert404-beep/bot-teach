...
def base(): return dict(certification_id="s1",archive_consistency_audit_reference=ref("f"),master_assurance_reference=ref("m"),release_certification_reference=ref("c"),final_audit_reference=ref("a"),certification_findings=(),boundary_assertions={"execution":False},trace_reference=ref("t"))
