...
def base(): return dict(verification_id="s1",archive_manifest_reference=ref("f"),master_assurance_reference=ref("m"),release_certification_reference=ref("c"),final_audit_reference=ref("a"),verified_references=("governance",),boundary_assertions={"execution":False},trace_reference=ref("t"))
