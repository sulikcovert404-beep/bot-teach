...
def base(): return {"signoff_id": "s1","final_governance_package_reference": ref("f"),"master_assurance_reference": ref("m"),"release_certification_reference": ref("c"),"final_audit_reference": ref("a"),"signoff_scope": ("governance",),"boundary_assertions": {"execution":False},"trace_reference": ref("t")}
