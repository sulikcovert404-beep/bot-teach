...
- provider مستقل Gemini Embedding و PgVectorStore برای foundation اضافه شده‌اند؛ benchmark کنترل‌شده lexical/vector در محیط Docker ایزوله اجرا شده است، اما نتیجهٔ production یا corpus واقعی فارسی محسوب نمی‌شود.
