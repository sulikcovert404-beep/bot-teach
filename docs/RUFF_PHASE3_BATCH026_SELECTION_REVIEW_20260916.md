# Ruff Phase 3 Batch 026 — Selection Review (2026-09-16)

## Candidate
- File: `tests/test_client_contract.py`
- Scope: test-only client contract checks.
...
## Focused tests
- `pytest --collect-only -q tests/test_client_contract.py`: 2 tests collected.
